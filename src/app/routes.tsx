...
const Website = lazy(() => import("@/features/website/pages/Website"));
const Admin = lazy(() => import("@/features/admin/pages/Admin"));
const AuctionDetail = lazy(() => import("../features/auction/pages/AuctionDetail"));
const LiveAuctions = lazy(() => import("@/features/auction/pages/LiveAuctions"));
const Auctions = lazy(() => import("@/features/auction/pages/Auctions"));
const PropertyDetails = lazy(() => import("@/features/property/pages/PropertyDetails"));
const ViewAllLots = lazy(() => import("@/features/property/pages/ViewAllLots"));
const AddProperty = lazy(() => import("@/features/property/pages/AddProperty"));
...
// ─── Direct Imports (Small Static Pages) ───
...
import Settings from "@/features/website/pages/Settings";
...
export const router = createBrowserRouter([
  ...
  {
    path: "/admin",
    Component: () => <ProtectedRoute allowedRoles={["admin"]}><Admin /></ProtectedRoute>,
  },
  {
    path: "/admin/profile",
    Component: () => <ProtectedRoute allowedRoles={["admin"]}><AdminProfile /></ProtectedRoute>,
  },
  {
    path: "/admin/overview",
    Component: () => <ProtectedRoute allowedRoles={["admin"]}><Admin /></ProtectedRoute>,
  ...
  },
  {
    ...
    Component: () => <ProtectedRoute allowedRoles={["admin", "agent"]}><AddProperty /></ProtectedRoute>,
  },
  {
    path: "/admin/properties/:id/edit",
    Component: () => <ProtectedRoute allowedRoles={["admin"]}><EditProperty /></ProtectedRoute>,
  },
  {
    path: "/admin/auctions",
    Component: () => <ProtectedRoute allowedRoles={["admin"]}><Admin /></ProtectedRoute>,
  },
  {
    ...
    Component: () => <ProtectedRoute allowedRoles={["admin"]}><EditAuction /></ProtectedRoute>,
  },
  {
    path: "/admin/bids",
    Component: () => <ProtectedRoute allowedRoles={["admin"]}><Bids /></ProtectedRoute>,
  },
  {
    path: "/admin/users",
    Component: () => <ProtectedRoute allowedRoles={["admin"]}><Admin /></ProtectedRoute>,
