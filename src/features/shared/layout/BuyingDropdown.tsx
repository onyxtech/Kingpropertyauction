import { ChevronRight, Grid3x3, BookOpen, Bell, Shield, ThumbsUp, DollarSign, Briefcase } from "lucide-react";

interface BuyingDropdownProps {
  show: boolean;
  onMouseEnter: () => void;
  onMouseLeave: () => void;
...
export default function BuyingDropdown({ show, onMouseEnter, onMouseLeave, onNavigate }: BuyingDropdownProps) {
  if (!show) return null;
    ...
    <div className="absolute top-full left-0 pt-2 w-72 z-[100] pointer-events-auto animate-in fade-in slide-in-from-top-2 duration-200">
      ...
      >
        ...
        <div className="relative space-y-1.5">
          <button
            onClick={() => onNavigate("/buying-overview")}
          ...
          <button
            onClick={() => onNavigate("/buying-guide")}
          ...
          <button
            onClick={() => onNavigate("/register-alert")}
          ...
          <button
            onClick={() => onNavigate("/terms-of-sale")}
        ...
        <div className="space-y-1.5">
          <button
            onClick={() => onNavigate("/why-buy-at-king")}
