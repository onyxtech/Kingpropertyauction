    ...
    try {
      ...
      if (data.success) {
        if (isLogin) {
          ...
          setSuccess(
            "✅ Account created! Awaiting admin approval. You can login once approved.",
          );
          setIsLogin(true);
            ...
            <div className="hidden lg:block">
              <div className="sticky top-24">
                ...
                <p className="text-xl text-slate-600 mb-8">
                  Create your account to access thousands of properties and
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-semibold hover:shadow-lg transition-shadow disabled:opacity-50"
                  >
                    {loading
                      ? "Please wait..."
                      : isLogin
                  ...
                  <div className="space-y-6">
                    <div>
                      <p className="text-slate-700 leading-relaxed">
                        Welcome to King Property Auction. By accessing or using
                        our platform, you agree to be bound by these Terms of
                    ...
                    <div>
                      <h4 className="text-xl font-black text-slate-900 mb-3 flex items-center gap-2">
                        <span className="size-8 rounded-lg bg-blue-100 text-blue-600 flex items-center justify-center font-black text-sm">
                          1
                        </span>
                        Acceptance of Terms
                      </h4>
                      <p className="text-slate-600 leading-relaxed ml-10">
                        By creating an account, accessing, or using the King
                        Property Auction platform, you acknowledge that you have
                        read, understood, and agree to be bound by these Terms
                        of Service and our Privacy Policy. If you do not agree
                    ...
                    <div>
                      ...
                      <div className="ml-10 space-y-2">
                        <p className="text-slate-600 leading-relaxed">
                          You must create an account to participate in auctions
                          and access certain features. You are responsible for:
                        </p>
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 leading-relaxed ml-10">
                        ...
                        property listings, we do not guarantee the accuracy,
                        completeness, or reliability of any information
                        provided. All property details should be independently
                    ...
                    <div>
                      ...
                      <div className="ml-10 space-y-2">
                        <p className="text-slate-600 leading-relaxed">
                          The bidding process is conducted in real-time through
                          our online platform. By participating:
                        </p>
                        <ul className="list-disc list-inside space-y-1 text-slate-600 pl-4">
                          <li>
                          ...
                          <li>
                            You must have sufficient funds to complete the
                            purchase
                          </li>
                          <li>
                            You agree to complete the transaction if you are the
                            winning bidder
                          </li>
                          <li>
                            Reserve prices may apply to certain properties
                          </li>
                          <li>
                            Bidding increments are determined by the auctioneer
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 leading-relaxed ml-10">
                        Payment for properties must be made in accordance with
                        our payment policies. A deposit may be required upon
                        winning a bid. Full payment terms will be specified in
                        the auction particulars. Failure to complete payment may
                    ...
                    <div>
                      ...
                      <div className="ml-10 space-y-2">
                        ...
                        <ul className="list-disc list-inside space-y-1 text-slate-600 pl-4">
                          <li>
                            Manipulate bidding or engage in fraudulent
                            activities
                          </li>
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 leading-relaxed ml-10">
                        Any disputes arising from the use of our platform or
                        services will be resolved through binding arbitration in
                        accordance with UK law. You waive your right to
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 leading-relaxed ml-10">
                        King Property Auction shall not be liable for any
                        indirect, incidental, special, or consequential damages
                        arising from your use of the platform. Our total
                        liability shall not exceed the fees paid by you in the
                        past 12 months.
                      </p>
                    </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-600">
                            ...
                            <a
                              href="mailto:legal@kingpropertyauction.com"
              ...
              >
                ...
                <div className="p-8 overflow-y-auto flex-1">
                  <div className="space-y-6">
                    <div>
                      <p className="text-slate-700 leading-relaxed">
                        King Property Auction is committed to protecting your
                        privacy and personal data. This Privacy Policy explains
                    ...
                    <div>
                      <h4 className="text-xl font-black text-slate-900 mb-3 flex items-center gap-2">
                        <span className="size-8 rounded-lg bg-purple-100 text-purple-600 flex items-center justify-center font-black text-sm">
                          1
                        </span>
                      ...
                      <div className="ml-10 space-y-3">
                        <div>
                          ...
                          <ul className="list-disc list-inside space-y-1 text-slate-600 pl-4">
                            ...
                            <li>
                              Identity verification documents (e.g., passport,
                              driver's license)
                            </li>
                        ...
                        <div>
                          ...
                          <ul className="list-disc list-inside space-y-1 text-slate-600 pl-4">
                            <li>
                              Browsing history and search queries on our
                              platform
                            </li>
                    ...
                    <div>
                      ...
                      <div className="ml-10 space-y-2">
                        ...
                        <ul className="list-disc list-inside space-y-1 text-slate-600 pl-4">
                          ...
                          <li>
                            To communicate with you about auctions and services
                          </li>
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 leading-relaxed ml-10">
                        ...
                        includes encryption, secure servers, firewalls, and
                    ...
                    <div>
                      ...
                      <div className="ml-10 space-y-2">
                        <p className="text-slate-600 leading-relaxed">
                          We may use trusted third-party services to enhance our
                          platform:
                        </p>
                        <ul className="list-disc list-inside space-y-1 text-slate-600 pl-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 leading-relaxed ml-10">
                        ...
                        policy, unless a longer retention period is required by
                        law. After this period, we will securely delete or
                        anonymize your data.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 leading-relaxed ml-10">
                        ...
                        preferences through your browser settings. Please note
                        that disabling cookies may affect platform
                        functionality.
                      </p>
                    </div>
                    ...
                    <div className="bg-purple-50 border-2 border-purple-200 rounded-2xl p-6">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-600">
                            To exercise your rights or for privacy-related
                            inquiries, contact our Data Protection Officer at{" "}
                            <a
                              href="mailto:privacy@kingpropertyauction.com"
