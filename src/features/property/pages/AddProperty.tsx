...
import {
  Building2, MapPin, Home, DollarSign, Image as ImageIcon, Upload,
  CheckCircle, ChevronRight, ChevronLeft, Sparkles, Bed, Bath, Square,
  Calendar, FileText, Star, Wifi, Car, Trees, Zap, Shield, Users,
  Camera, Video, X, Globe, Map, Gavel, UserCheck, Lock, Scale, Info,
} from "lucide-react";
...
export default function AddProperty() {
  ...
  const { mutateAsync: createProperty, isPending: apiLoading } = useCreateProperty();
